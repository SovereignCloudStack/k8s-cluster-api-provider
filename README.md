...
`deploy_k8s_openstack_git` | `DEPLOY_K8S_OPENSTACK_GIT` | SCS | `true` | Deploy latest upstream OCCM version from git instead of v1.19.2. Disable for k8s <= 1.19.
`deploy_k8s_cindercsi_git` | `DEPLOY_K8S_CINDERCSI_GIT` | SCS | `true` | Deploy latest upstream cinder CSI version from git instead of v2.2.0. Dito.
