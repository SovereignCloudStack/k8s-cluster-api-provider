...
`deploy_occm` | `DEPLOY_OCCM` | SCS | `true` | Deploy the given version of OCCM into the cluter. true (default) choses the latest version matching the k8s version. You can specify `master` to chose the upstream master branch.
