...
| nginx-ingress  | 1.8.x   | Supports only k8s version >= 1.24. We dropped support for older k8s versions. [supported versions](https://github.com/kubernetes/ingress-nginx#supported-versions-table). |
...
| k8s            | 1.27   | See [below](#k8s-versions-124----127).                                                                                                                                           |
