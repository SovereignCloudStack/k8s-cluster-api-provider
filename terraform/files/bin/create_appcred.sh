...
if test -z "$APPCRED_ID"; then
       ...
       # Replace secret
       print-cloud.py -c $PREFIX-$CLUSTER_NAME -r application_credential_id=$APPCRED_ID -r application_credential_secret=$APPCRED_SECRET -i auth_type="#project_id=$APPCRED_PRJ" >> ~/.config/openstack/clouds.yaml
       # And remove from env
